...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-05-2024 a las 23:26:38
...
INSERT INTO `empleado` (`numeroidentificacione`, `nombre1`, `apellido1`, `estado_civile`, `tipodoce`, `correoe`, `celulare`, `generoe`, `fecha_nacimiento`, `fechaexpdocu`, `nit`, `id_rol`, `intentos_fallidos`, `bloqueado`, `contrasena`) VALUES
('100333232', 'johan', 'pinzon', 'viudo', 'CE', 'helmut@gamial', '3125252', 'masculino', '2024-03-13', '2024-03-04', '121321231', 3, 0, 0, '1212'),
('103154', 'Helmut', 'Romero', 'soltero', 'CC', 'helmut@gmail.com', '32154564', 'no_indica', '2024-03-06', '2024-03-12', '121321231', 1, 0, 0, '1414'),
('121222525', 'dajaja', 'dejeje', 'soltero', 'CE', 'dajaja@gmail.com', '205889642', 'femenino', '2004-07-14', '2022-05-24', '121321231', 1, 2, 0, '$2y$10$qxCJ2pFAD4DyPche7iFj8O4jdKUFEsdH5D6nRQl3yHX3ulKqWG9qq');
...
ALTER TABLE `empleado`
  ...
  ADD CONSTRAINT `empleado_ibfk_2` FOREIGN KEY (`id_rol`) REFERENCES `roles` (`id_rol`),
