...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-05-2024 a las 07:34:23
...
INSERT INTO `empleado` (`numeroidentificacione`, `nombre1`, `apellido1`, `estado_civile`, `tipodoce`, `correoe`, `celulare`, `generoe`, `fecha_nacimiento`, `fechaexpdocu`, `idRol`, `nit`, `contrasena`) VALUES
('100333232', 'Diiego', 'Camiino', 'Casado', 'CC', 'diiego@gmail.com', '3125252', 'masculino', '2024-03-13', '2024-03-04', 1, '121321231', '1212');
...
('121321231', 'Sena', '333332233', 'sena@utlook.edu.com');
...
ALTER TABLE `empleado`
  ...
  ADD CONSTRAINT `empleado_ibfk_2` FOREIGN KEY (`idRol`) REFERENCES `rol` (`idRol`) ON DELETE CASCADE ON UPDATE CASCADE,
